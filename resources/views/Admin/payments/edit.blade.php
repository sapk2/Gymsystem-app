                    ...
                    <form action="{{route('admin.payments.update',$payments->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2" >
                            <div class="mb-4">
                                ...
                                <select name="user_id" id="user_id"class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    ...
                                    @foreach ($user as $user)
                                        <option value="{{$user->id}}"{{$payments->user_id==$user->id ? 'selected':''}}>{{$user->name}}-{{$user->email}}</option>
                                    @endforeach
                                </select>
                                @error('user_id')
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" name="payment_date" value="{{$payments->payment_date}}" id="payment_date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                @error('payment_date')
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="amount" value="{{$payments->amount}}" id="amount" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                @error('amount')
                                    <span class="text-red-500 text-base">{{$message}}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <select name="payment_method" id="payment_method" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    ...
                                    <option value="Bank"{{$payments->payment_method=='Bank'? 'selected':''}}>Bank</option>
                                    <option value="Cheque"{{$payments->payment_method=='cheque'? 'selected':''}}>Cheque</option>
                                </select>
                                ...
                                <input type="text" name="transaction_id" value="{{$payments->transaction_id}}" id="transaction_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            <div>
                                ...
                                <select name="status" id="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option value="complete"{{$payments->status == 'complete' ? 'selected' : ''}}>complete</option>
