        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="bg-gray-700 p-4 rounded-md mb-4 flex justify-between items-center">
                    ...
                    <a href="{{route('admin.users.create')}}" class="px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-800 transition">Add New</a>
                </div>
                          ...
                          @foreach ($user as $user)
                              <tr>
                                ...
                                <td class="border px-2 py-4">
                                    <a href="{{route('admin.users.edit',$user->id)}}" class="text-white bg-blue-700 rounded-md text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700  hover:bg-blue-800">edit</a>
                                    <a href="{{route('admin.users.delete',$user->id)}}" onclick="return confirm('Are you sure?')" class="text-white bg-red-700 rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700  hover:bg-red-800">Delete</a>
                                </td>
                              </tr>
                          @endforeach
                        </tbody>
