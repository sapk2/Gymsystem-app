        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="bg-gray-700 p-4 rounded-md mb-4 flex justify-between items-center">
                    ...
                    <a href="{{route('admin.managetrainers.create')}}" class="px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-800 transition">Add New</a>
                </div>
                          ...
                          @foreach ($trainer as $trainer)
                              <tr>
                                ...
                                <td class="border px-2 py-4 ">
                                    <a href="{{route('admin.managetrainers.edit',$trainer->id)}}" class="bg-blue-600 text-white px-4 py-2 rounded-lg">edit</a>
