                ...
                <div class="container mt-2">
                    ...
                    <form action="{{route('admin.managetrainers.update',$trainer->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mt-6">
                            ...
                            <input type="date" value="{{$trainer->end_at}}" name="end_at" class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" required />
                        </div>
